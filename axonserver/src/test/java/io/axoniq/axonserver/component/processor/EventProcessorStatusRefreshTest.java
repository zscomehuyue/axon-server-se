...
public class EventProcessorStatusRefreshTest {
    ...
    private EventProcessorIdentifier processorA = new NameBasedEventProcessorIdentifier("processorA");
    private EventProcessorIdentifier processorB = new NameBasedEventProcessorIdentifier("processorB");
    private EventProcessorIdentifier processorC = new NameBasedEventProcessorIdentifier("processorC");
